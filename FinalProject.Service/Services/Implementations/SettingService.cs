...
namespace FinalProject.Service.Services.Implementations
{
    public class SettingService : ISettingService
    {
        ...
        private readonly IGenericRepository<DAL.Entities.Message> _messageRepository;
        private readonly ICarService _carService;

        public SettingService(IGenericRepository<Setting> repository, IMapper mapper, IWebHostEnvironment evn, IHttpContextAccessor http, IGenericRepository<Blog> blogRepository, IAccountService accountService, ICarImageService carImageService, IGenericRepository<DAL.Entities.Message> messageRepository, ICarService carService)
        {
