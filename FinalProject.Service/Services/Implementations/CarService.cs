...
namespace FinalProject.Service.Services.Implementations
{
    public class CarService : ICarService
    {
        ...
        public CarService(IGenericRepository<Car> repository, IMapper mapper, IWebHostEnvironment evn, IHttpContextAccessor http, CustomDBContext context, IGenericRepository<Brand> brandRepository, IBrandService brandService, IAccountService accountService, ISubscribeService subscribeService, IEmailService emailService)
        {
